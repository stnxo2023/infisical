...
<Steps>
    ...
    <Step title="Configure user details and role">
        ...
        GRANT ALL PRIVILEGES ON ALL SECRETS IN SCHEMA SECRET_SYNC_TEST.PUBLIC TO ROLE INFISICAL_ROLE;
        GRANT ALL PRIVILEGES ON FUTURE SECRETS IN SCHEMA SECRET_SYNC_TEST.PUBLIC TO ROLE INFISICAL_ROLE;
        ```
