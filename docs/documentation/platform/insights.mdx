...
![Secret Insights rotation](/images/platform/insights/reminders.png)
...
**Event pills.** Each day cell shows up to two events; if there are more, a **+N more** pill expands the rest. Pills are color-coded:
