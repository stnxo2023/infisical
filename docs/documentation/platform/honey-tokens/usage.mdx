...
<Steps>
  ...
  <Step title="Step 1: Environment">
    Configure where the honey token will be planted:
  ...
  <Step title="Step 2: Mapping">
    Configure **Secrets Mapping**:
  ...
  <Step title="Step 3: Details">
    Add the token metadata:
